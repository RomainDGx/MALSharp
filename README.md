...
- **[MALSharp.Models](./MALSharp.Models)**: Reusable POCO models decoupled from the transport layer.
- **[MALSharp.Client](./MALSharp.Client)**: A strongly-typed, easy-to-use REST API client.
- **[MALSharp.Client.Hosting](./MALSharp.Client.Hosting)**: DI integration for **MALSharp.Client**.
